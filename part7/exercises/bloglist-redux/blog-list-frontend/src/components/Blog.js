  ...
  return (
    <div style={singlePostStyle} className="blog">
      <div style={buttonParentStyle}>
        <p className="blogTitle" style={buttonNeighborStyle}>
          <strong>Title:</strong> <Link to={blogUrl}>{blog.title}</Link>
        </p>
      ...
      <div style={blogContent}>
        <div style={visibilityStyle}>
          ...
          <div style={buttonParentStyle}>
            <p style={buttonNeighborStyle} className="blogLikes">
              <strong>Likes:</strong> {blog.likes}
            </p>
            <button
              style={buttonStyle}
              onClick={(event) => handleLikes(event, blog)}
            >
              like
            </button>
          </div>
          <p className="blogUser">
            <strong>User:</strong> {blog.user.username}
          </p>
          {deleteButton()}
        </div>
      </div>
